...
@RestController
@ControllerAdvice
public class ZoneControllerAdvice extends ResponseEntityExceptionHandler {

    @ExceptionHandler(ZoneNotFoundException.class)
    public ResponseEntity<CICMExceptionResponse> handleZoneNotFoundException(
            ZoneNotFoundException exception,
            WebRequest request
    ) {
